...
#TODO: Change this into symlinks for all the folders that will need to be backed up.
# otherwise we can just naively backup /var/lib/www
#
...
# Change permissions for all folders to www-data user.
chown -R www-data: .
